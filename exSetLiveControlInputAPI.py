# original author: Evan Bottango
# modified by: Lucia Alday
# date last modified: 3/28/25
# purpose: take control inputs from a facial tracking thing and live video
# set response to bottango bird animatronic
